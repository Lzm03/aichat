        ...
        >
          ...
          >
            <div className="bg-[radial-gradient(circle_at_top_left,rgba(99,102,241,0.18),transparent_36%),radial-gradient(circle_at_bottom_right,rgba(16,185,129,0.16),transparent_34%)] px-7 py-7">
              <div className="inline-flex rounded-full border border-indigo-200 bg-white/80 px-3 py-1 text-xs font-semibold text-indigo-700">{uiText("感謝試用")}</div>
              <h2 className="mt-4 text-3xl font-black tracking-tight text-slate-900">{uiText("感謝您試用我們的機器人平台！")}</h2>
              <p className="mt-4 text-sm leading-7 text-slate-600">{uiText("我們的開發團隊十分想聽到您的意見。如果你想提供意見，或瞭解和購買我們的機器人創建服務，歡迎直接聯絡我們。")}</p>
            </div>
            ...
            <div className="grid gap-4 px-7 py-6">
              <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
                ...
                <p className="mt-2 text-sm text-slate-500">{uiText("歡迎提交產品意見、合作需求或購買方案查詢。")}</p>
              </div>
            </div>
