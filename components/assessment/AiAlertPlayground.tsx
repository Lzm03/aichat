      ...
      <div className="min-h-[80px]">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div>
              <h3 className={`text-sm font-bold ${currentScenario.theme.text}`}>{currentScenario.alertTitle}</h3>
              <p className={`text-sm mt-1 opacity-90 ${currentScenario.theme.text}`}>{currentScenario.alertMessage}</p>
            </div>
          </motion.div>
        </AnimatePresence>
      </div>
              ...
              <div className="bg-purple-50 rounded-2xl p-5 border border-purple-100 relative mt-8">
                ...
                <div className="flex justify-between items-start mb-4 mt-2">
                  ...
                  <div className="text-right shrink-0 bg-white px-4 py-2 rounded-xl shadow-sm border border-purple-100">
                    ...
                    <span className="text-sm font-medium text-slate-400"> / 5 分</span>
                  </div>
                </div>
                ...
                <div className="bg-white/60 p-3 rounded-xl">
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed">
                    根據系統偵測，此作答觸發了「{currentScenario.tabLabel}」的異常警示，因此暫不給予常規評分，建議由教師人工介入處理。
                  </p>
                </div>
