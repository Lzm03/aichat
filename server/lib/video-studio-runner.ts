...
const SLOT_PROMPTS: Record<VideoStudioSlotKey, string> = {
  idle:
    "Silent idle only. Priority rule: silent mouth lock is mandatory. Character stands in place with both feet planted at exactly the same position. No walking, no stepping, no body translation, no turn-and-shift. Mouth must stay naturally closed for the entire clip: no speech, no lip-sync, no mouth opening, no visible teeth, no tongue, no jaw rhythm. Only subtle breathing and occasional natural blinking are allowed. Camera is fully locked: no zoom, no dolly, no pan, no tilt, no shake. Do not move or reframe the shot. Background must be pure chroma key green (RGB near 0,255,0), fully uniform, flat, and clean: no gradient, no texture, no noise, no shadow, no reflection, no hotspot, no depth-of-field blur, no background objects. No green spill or green edge on the subject. Keep crisp, clean subject edges with clear hair strands, fingers, and clothing contours for easy keying. If any constraint conflicts, enforce this order: no speaking > no movement > locked camera > green screen quality.",
  speaking:
    "Speaking mode. Character stands in place with both feet planted at the same position. No walking, no stepping, no body translation, no turn-and-shift. Natural speech lip-sync is allowed with clear mouth articulation and subtle facial expression changes. Keep motion restrained: only tiny head micro-movements and natural blinking; no body relocation. Camera is fully locked: no zoom, no dolly, no pan, no tilt, no shake. Background must be pure chroma key green (RGB near 0,255,0), fully uniform and clean: no gradient, no texture, no noise, no shadow, no reflection, no hotspot, no depth blur, no background objects. No green spill or green edge on the subject. Keep crisp, clean edges for hair strands, fingers, and clothing contours.",
  thinking:
    "Thinking mode, silent. Character stands in place with both feet planted at exactly the same position. No walking, no stepping, no body translation, no turn-and-shift. No speech and no lip-sync. Mouth stays closed with no speaking-related jaw rhythm. Allowed actions: subtle thinking expressions only, such as slight brow movement, tiny eye movement, brief upward glance, and minimal head micro-tilt. Camera is fully locked: no zoom, no dolly, no pan, no tilt, no shake. Background must be pure chroma key green (RGB near 0,255,0), fully uniform and clean: no gradient, no texture, no noise, no shadow, no reflection, no hotspot, no depth blur, no background objects. No green spill or green edge on the subject. Keep crisp, clean edges for hair strands, fingers, and clothing contours. If constraints conflict, prioritize: silent mouth > no movement > locked camera > green screen quality.",
};
